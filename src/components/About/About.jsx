...
export const About = () => {
    return <section id="about" className={styles.container}>
        ...
        <div className={styles.content}>
            <img
                src={getImageUrl("about/hike_bridge.jpg")}
                alt="Temporary image"
