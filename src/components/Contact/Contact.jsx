            ...
            <ul className={styles.contactItems}>
                <li className={styles.contactItem}>
                    <div className={styles.contactItemText}>
                        ...
                        <p>Feel free to send me an <a href="mailto:frida_mattsson97@hotmail.com" className={styles.email}>email</a>, give me a call or message me on LinkedIn. I'll happily get back to you ASAP.</p>
                    </div>
                </li>
            </ul>
        </div>
